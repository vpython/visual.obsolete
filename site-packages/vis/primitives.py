...
##        self.__start = shape.start
##        self.__start = shape.starts
        ...
        if self.__align == 'left':
            displace = vector(self.__width/2,0,0)
        elif self.__align == 'right':
            displace = vector(-self.__width/2,0,0)
        else:
            displace = vector(0,0,0)
        if self.__depth.z < 0: # adjust for case of backward extrusion
            p = [displace, self.__depth+displace]
        else:
            p = [self.__depth+displace, displace]
