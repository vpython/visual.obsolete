...
def ceil(x):
    if type(x) is float: return _m_ceil(x)
    return _n_ceil(x)
def cos(x):
    if type(x) is float: return _m_cos(x)
    return _n_cos(x)
def cosh(x):
    if type(x) is float: return _m_cosh(x)
    return _n_cosh(x)
def exp(x):
    if type(x) is float: return _m_exp(x)
    return _n_exp(x)
def fabs(x):
    if type(x) is float: return _m_fabs(x)
    return _n_fabs(x)
def floor(x):
    if type(x) is float: return _m_floor(x)
    return _n_floor(x)
def fmod(x):
    if type(x) is float: return _m_fmod(x)
    return _n_fmod(x)
def frexp(x):
    if type(x) is float: return _m_frexp(x)
    return _n_frexp(x)
def hypot(x):
    if type(x) is float: return _m_hypot(x)
    return _n_hypot(x)
def ldexp(x):
    if type(x) is float: return _m_ldexp(x)
    return _n_ldexp(x)
def log(x):
    if type(x) is float: return _m_log(x)
    return _n_log(x)
def log10(x):
    if type(x) is float: return _m_log10(x)
    return _n_log10(x)
def modf(x):
    if type(x) is float: return _m_modf(x)
    return _n_modf(x)
def sin(x):
    if type(x) is float: return _m_sin(x)
    return _n_sin(x)
def sinh(x):
    if type(x) is float: return _m_sinh(x)
    return _n_sinh(x)
def sqrt(x):
    if type(x) is float: return _m_sqrt(x)
    return _n_sqrt(x)
def tan(x):
    if type(x) is float: return _m_tan(x)
    return _n_tan(x)
def tanh(x):
    if type(x) is float: return _m_tanh(x)
    return _n_tanh(x)
