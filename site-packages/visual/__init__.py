...
from . import cvisual as _cvisual
...
# Names defined for backward compatibility with old programs that may still be in use:
true = True # When Visual was created in 2000, Python didn't have True/False
false = False
crayola = color # In retrospect, crayola.py should have been colors.py, like materials.py
...
# But maybe this is no longer needed? Works okay on Windows without this. (BAS 2010/10/7)
