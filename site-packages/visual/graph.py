...
class gdisplay:
    def __init__(self, x=0, y=0, width=800, height=400,
        ...
        self.gscale = array([self.width/(self.minmax[xaxis][posaxis]+self.minmax[xaxis][negaxis]),
                        self.height/(self.minmax[yaxis][posaxis]+self.minmax[yaxis][negaxis]),1.0])
    ...
    def resize(self, x, y):
        ...
        if (redox or redoy):
            newgscale = array([self.width/(self.minmax[xaxis][posaxis]+self.minmax[xaxis][negaxis]),
                            self.height/(self.minmax[yaxis][posaxis]+self.minmax[yaxis][negaxis]),1.0])
...
class ghistogram:
    def __init__(self, bins=None, accumulate=0, average=0,
        ...
        self.vbars = faces(display=self.gdisplay.display,
                           ...
                           normal=znormal, color=self.color)
        self.gdisplay.graphs.append(self.vbars)
        self.gdisplay.resize(bins[0],1.0)
        self.gdisplay.resize(bins[-1],1.0)
...
# Only one numeric label visible (x = -25). For some zooms, vbars disappear.
# Histogram bug (long-standing): x axis typically one bin too short.
