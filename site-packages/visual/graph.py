...
# For backward compatibility with programs that do "from visual.graph import *"
# as a substitute for "from visual import *", expecting to be able to make
# spheres etc., it is necessary that this file do "from visual import *".
# Since there are many enhancements desired for the graphing package, any
# future version should require programs to import visual objects separately
# from the graphing machinery.
