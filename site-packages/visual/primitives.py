...
class text(object):
    ...
    def alignText(self):
        for line in range(len(self.lines)):
            ...
            if self.__align == 'left':
                ...
                self.backframe[line].pos = -vector(self.__width,0,0)+v
    ...
    def set_material(self, material):
        for line in range(len(self.lines)):
            self.front[line].material = self.back[line].material = self.sides[line].material = self.__material = material
    def get_material(self):
        return self.__material

    def set_color(self, color):
        for line in range(len(self.lines)):
            self.front[line].color = self.back[line].color = self.sides[line].color = self.__color = color
    def get_color(self):
        return self.__color
