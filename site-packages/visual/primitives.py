...
def process_init_args_from_keyword_dictionary( displayobject, keywords, arrayobject=False):
   ...
   if not keywords.has_key('material') and not isinstance(displayobject, cvisual.light):
...
class distant_light (cvisual.distant_light, py_renderable):
   def __init__( self, _other=None, **keywords):
      if _other:
         cvisual.distant_light.__init__(self, _other)
         py_renderable.__init__(self, keywords, _other)
         copy_object( self, _other, keywords)
      else:
         cvisual.distant_light.__init__(self)
         py_renderable.__init__(self, keywords)
         process_init_args_from_keyword_dictionary(self, keywords)
   def __copy__( self, **keywords):
      return distant_light(_other=self, **keywords)

class local_light (cvisual.local_light, py_renderable):
   def __init__( self, _other=None, **keywords):
      if _other:
         cvisual.local_light.__init__(self, _other)
         py_renderable.__init__(self, keywords, _other)
         copy_object( self, _other, keywords)
      else:
         cvisual.local_light.__init__(self)
         py_renderable.__init__(self, keywords)
         process_init_args_from_keyword_dictionary(self, keywords)
   def __copy__( self, **keywords):
      return local_light(_other=self, **keywords)
