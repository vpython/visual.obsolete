...
def shader( name, shader, library = library, **kwargs ):
    ...
    s = ""
    for l in shader.split("\n"):
        s += "\n"+l.strip()
    shader = library+s
## The following statement is a compact version of the previous 4 statements
## but is not valid in Python 2.3, which ships with Mac OS X 10.4.
