...
#   driver to load glade data files (the [:-3] truncates visual to vis)
#import os.path as _os_path
#cvisual._set_dataroot( _os_path.split( __file__ )[0][:-3] + _os_path.sep)
