...
class AboutDialog(Toplevel):
    ...
    def CreateWidgets(self):
        ...
        labelTitle = Label(frameBg, text='VIDLE', fg=self.fg, bg=self.bg,
        ...
        #                  padx=0, pady=3)
        byline = "Python's Integrated DeveLopment Environment (VPython fork)" + 5*'\n'
        ...
        labelWWW = Label(frameBg, text='www:  http://www.vpython.org/vidle/',
                         justify=LEFT, fg=self.fg, bg=self.bg)
        ...
        Frame(frameBg, borderwidth=1, relief=SUNKEN,
              height=2, bg=self.bg).grid(row=11, column=0, sticky=EW,
                                         columnspan=3, padx=5, pady=5)
        idle_v = Label(frameBg, text='VIDLE version:   ' + idlever.IDLE_VERSION,
                       fg=self.fg, bg=self.bg)
