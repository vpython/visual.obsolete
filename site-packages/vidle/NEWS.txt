What's New in VIDLE 1.3?
========================

*Release date: 27-MAR-2009*

- Changed name to "VIDLE" to reflect (hopefully temporary) fork
- fix: Unreliable and slow termination of user program on Windows
- fix: Missing preferences and other menus on Macintosh
- Use any port for RPC server, so multiple instances of VIDLE can
