VIDLE is a (hopefully temporary) fork of IDLE, by the VPython team.
We have changed its name because we don't want those responsible
for maintaining the version of IDLE included with Python itself to
be confused by questions about this version.  

Information about this fork of IDLE can be found at 
        http://www.vpython.org/vidle/
