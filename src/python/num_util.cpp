...
numeric::array makeNum(int * data, int n){
  object obj(handle<>(PyArray_FromDims(1, &n, PyArray_INT)));
  char *arr_data = ((PyArrayObject*) obj.ptr())->data; 
  std::memcpy(arr_data, data, sizeof(int) * n); // copies the input data to 
                                           // PyArrayObject->data
  return extract<numeric::array>(obj);
}

numeric::array makeNum(float * data, int n){
  object obj(handle<>(PyArray_FromDims(1, &n, PyArray_FLOAT)));
  char *arr_data = ((PyArrayObject*) obj.ptr())->data; 
  std::memcpy(arr_data, data, sizeof(float) * n);
  return extract<numeric::array>(obj);
}
  
numeric::array makeNum(double * data, int n){
  object obj(handle<>(PyArray_FromDims(1, &n, PyArray_DOUBLE)));
  char *arr_data = ((PyArrayObject*) obj.ptr())->data;
  std::memcpy(arr_data, data, sizeof(double) * n);
  return extract<numeric::array>(obj);
}
...
numeric::array makeNum(char * data, std::vector<int> dims){
  ...
  char *arr_data = ((PyArrayObject*) obj.ptr())->data;
  std::memcpy(arr_data, data, sizeof(char) * total);
  return extract<numeric::array>(obj);
}
...
numeric::array makeNum(short * data, std::vector<int> dims){
  ...
  char *arr_data = ((PyArrayObject*) obj.ptr())->data;
  std::memcpy(arr_data, data, sizeof(short) * total);
  return extract<numeric::array>(obj);
}
...
numeric::array makeNum(int * data, std::vector<int> dims){
  ...
  char *arr_data = ((PyArrayObject*) obj.ptr())->data;
  std::memcpy(arr_data, data, sizeof(int) * total);
  return extract<numeric::array>(obj);
}
...
numeric::array makeNum(float * data, std::vector<int> dims){
  ...
  char *arr_data = ((PyArrayObject*) obj.ptr())->data;
  std::memcpy(arr_data, data, sizeof(float) * total);
  return extract<numeric::array>(obj);
}
...
numeric::array makeNum(double * data, std::vector<int> dims){
  ...
  char *arr_data = ((PyArrayObject*) obj.ptr())->data;
  std::memcpy(arr_data, data, sizeof(double) * total);
  return extract<numeric::array>(obj);
}
...
int rank(const numeric::array& arr){
...
std::vector<int> shape(const numeric::array& arr) {
...
char* data(const numeric::array& arr){
