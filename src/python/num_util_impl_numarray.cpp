...
#else
	throw std::runtime_error( "This build of Visual does not support Numarray." );
#endif
}

#if VISUAL_HAVE_NUMARRAY
...
#else
	throw std::runtime_error( "This build of Visual does not have support for Numarray");
#endif
}
