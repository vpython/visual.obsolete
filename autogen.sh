...
if -e Makefile.in ; then echo "ok Makefile.in"
else
    echo "Makefile.in not generated"
fi

if -e aclocal.m4 ; then echo "ok aclocal.m4"
else
    echo "aclocal.m4n not generated"
fi

if -e config.guess ; then echo "ok config.guess"
else
    echo "config.guess not generated"
fi

if -e config.sub ; then echo "ok config.sub"
else
    echo "config.sub not generated"
fi

if -e configure ; then echo "ok configure"
else
    echo "configure not generated"
fi

if -e install-sh ; then echo "ok install-sh"
else
    echo "install-sh not generated"
fi

if -e ltmain.sh ; then echo "ok ltmain.sh"
else
    echo "ltmain.sh not generated"
fi

if -e missing ; then echo "ok missing"
else
    echo "missing not generated"
fi

if -e py-compile ; then echo "ok py-compile"
else
    echo "py-compile not generated"
fi

if -e site-packages/visual/Makefile.in ; then echo "ok site-packages/visual/Makefile.in"
else
    echo "site-packages/visual/Makefile.in not generated"
fi

if -e site-packages/vis/Makefile.in ; then echo "ok site-packages/vis/Makefile.in"
else
    echo "site-packages/vis/Makefile.in not generated"
fi

if -e examples/Makefile.in ; then echo "ok examples/Makefile.in"
else
    echo "examples/Makefile.in not generated"
fi

if -e docs/Makefile.in ; then echo "ok docs/Makefile.in"
else
