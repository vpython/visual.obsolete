...
namespace cvisual { namespace python {
   ...
   */
  boost::python::numeric::array makeNum(int * data, int n=0);
   ...
   *@return a Numeric array of size n with elements initialized to data.
   */
  boost::python::numeric::array makeNum(float * data, int n=0);
   ...
   *@return a Numeric array of size n with elements initialized to data.
  */
  boost::python::numeric::array makeNum(double * data, int n=0);
  ...
  */
   ...
   */
  int rank(const boost::python::numeric::array& arr);
  ...
  */
  std::vector<int> shape(const boost::python::numeric::array& arr);
  ...
  */
   ...
   */
  char* data(const boost::python::numeric::array& arr);
